...
const schema = defineSchema(
  {
     ...
     *
     * Phase 270 — RETAINED FROZEN. The email-OTP provider was retired, so
     * this table no longer receives writes in production. It is kept
     * deliberately: dropping deployed tables/rows is a separate
     * data-lifecycle decision that Phase 270 does not make. Do not delete.
     */
