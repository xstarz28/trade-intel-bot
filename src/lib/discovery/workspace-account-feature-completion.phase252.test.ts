...
describe("Phase252 73 — email OTP regression", () => {
  it("emailOtp is retired (Phase 270 amendment)", () => {
    ...
    /* The pre-270 pin was "emailOtp still present": the infrastructure stayed
       while retiring was a pending decision. Phase 270 made that decision.
       The same regression guarantee survives inverted and stronger — no
       trace of the retired provider may reappear in the auth surface. */
