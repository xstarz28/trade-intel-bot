...
describe("Phase263 L — Alpha Vantage INDEX_CATALOG DXY (Phase265: IMPLEMENTED)", () => {
  it("Alpha Vantage implementation now includes INDEX_CATALOG/INDEX_DATA plus NEWS_SENTIMENT, OVERVIEW, EARNINGS", () => {
  ...
  it("Alpha Vantage docs: INDEX_DATA requires premium, DXY determination from actual catalog (Phase265)", () => {
    ...
    // DXY determination documented in readiness or capability
