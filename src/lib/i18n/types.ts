...
export interface Translations {
  ...
  analysisResult: {
    ...
    advancedTechnical: {
      ...
      crossMarketTitle: string;
      orderFlowTitle: string;
      derivativesTitle: string;
      hierarchyTitle: string;
      sessionVwapLabel: string;
      anchoredVwapLabel: string;
      bandsLabel: string;
      ...
      sweepLabel: string;
      levelInteractionLabel: string;
      displacementLabel: string;
      fvgLabel: string;
      zonesLabel: string;
      sessionAuctionLabel: string;
      ...
      intermarketLabel: string;
      bidAskLabel: string;
      spreadLabel: string;
      depthLabel: string;
      depthImbalanceLabel: string;
      unavailableLabel: string;
      unavailableMetricsLabel: string;
   ...
   */
  auth: {
    // Phase 270: the 17 email-OTP copy keys are retired with the provider (provider + client surface both gone).
    title: string;
    subtitle: string;
