...
export const RELEASE_PREREQUISITES: readonly Prerequisite[] = [
  ...
  /* Phase 270 retire-unlinked: PRODUCTION_EMAIL_TRANSPORT is no longer a
     prerequisite. It proved a real email delivery path for email-OTP sign-in;
     Phase 270 retired that provider, so there is no capability left for the
     proof to establish. Keeping the requirement would gate releases on
     evidence of a feature that does not exist. The former id remains retired,
     not reusable. */
  {
