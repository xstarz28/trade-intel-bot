 ...
 * which in turn imports the real `deploymentEnvironment`, `issuerPolicy`,
 * `emailDelivery` and provider-credential modules, so the checker and the running
 * backend cannot disagree about what production accepts.
 *
 * Exit codes:
